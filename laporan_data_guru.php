          ...
          <div class="col-md-5">
            <ul class="list-group master-data link-dark">
              ...
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_inventaris/inventaris_show.php" class="nav-link text-dark ">
                <i class="bi bi-box-seam"></i> <i class="ms-3"></i> Data Inventaris
                </a>
              </li>
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_pinjam/pinjam_show.php" class="nav-link text-dark ">
                <i class="bi bi-chevron-double-right"></i><i class="ms-3"></i>  Data Pinjaman Inventaris
                </a>
              </li>
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_pengembalian/pengembalian_show.php" class="nav-link text-dark ">
                <i class="bi bi-chevron-double-left"></i><i class="ms-3"></i> Data Pengembalian Inventaris
                </a>
              </li>                        
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_kinerja/kinerja_show.php" class="nav-link text-dark ">
              ...
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_kelas/kelas_show.php" class="nav-link text-dark ">
              ...
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_rapot_siswa/rapot_show.php" class="nav-link text-dark ">
                <i class="bi bi-journal-text"></i><i class="ms-3"></i>  Data Rapor Siswa
                </a>
              </li>      
              <li class="list-group-item list-group-item-dark">
                <a href="data_guru/tb_mapel/mapel_show.php" class="nav-link text-dark ">
