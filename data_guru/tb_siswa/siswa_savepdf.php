...
$jlhjk = queryTampilsiswa("SELECT * FROM filter_jlhjk");
...
$html .= '
                <tr>
                  ...
                  <td><img src="../../gambar/'. $row["gambar"] .'"width="70px"></td>
                </tr>';
              }      
$html .= '
              </table>
...
$mpdf->Output('Laporan Data siswa.pdf', \Mpdf\Output\Destination::INLINE);
