...
if(isset($_POST["submit"])) {
  if(hapussiswa($id)>0) {
    echo"<script>alert('Data siswa Berhasil Dihapus');document.location.href = 'siswa_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data siswa Gagal Dihapus');document.location.href = 'siswa_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Siswa <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data Siswa</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      NIS
                      <div class="fw-bold"><?= $tb_siswa["nis"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama siswa
                      <div class="fw-bold"><?= $tb_siswa["nama"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Jenis Kelamin
                      <div class="fw-bold"><?= $tb_siswa["jenis_kelamin"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Alamat Lengkap
                      <div class="fw-bold"><?= $tb_siswa["alamat"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Tanggal Lahir
                      <div class="fw-bold"><?= $tb_siswa["tanggal_lahir"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tempat Lahir
                      <div class="fw-bold"><?= $tb_siswa["tempat_lahir"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                     <div class="ms-2 me-auto">
        ...
        <div class="row">
          <div class="col">
            ...
            <a href="siswa_filter_savepdf.php?id=<?= $_GET["id"]; ?>" >
                    <button type="button"  class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data Siswa</button>
                </a>
            </form>
          </div>
        </div>
