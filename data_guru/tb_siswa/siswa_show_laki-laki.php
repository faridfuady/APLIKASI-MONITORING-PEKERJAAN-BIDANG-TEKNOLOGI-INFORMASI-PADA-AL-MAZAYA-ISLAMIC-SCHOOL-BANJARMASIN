...
$siswa = queryTampilsiswa("SELECT * FROM tb_siswa WHERE jenis_kelamin = 'Laki - Laki'");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark-dark mb-5 text-center">Tabel Data siswa <br> AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md-7">
            <a href="../../index.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-house-door-fill"></i> Kembali ke Beranda</button>
            </a>
            <a href="siswa_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data siswa</button>
            </a>
            <a href="siswa_savepdf_laki-laki.php">
          ...
          <div class="col-md-5">
            <div class="input-group mb-3">
              <form action="" method="post" class="d-flex">         
                <input type="text" class="form-control" placeholder="Cari Nama siswa" name="keyword" size="70">
                <button class="btn btn-outline-primary ms-1" type="submit" name="carisiswa"><i class="bi bi-search"></i></button>
              </form>
            </div>
          </div>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <a href="siswa_filter.php?id=<?= $row["id"]; ?>">
                  ...
                  <a href="siswa_update.php?id=<?= $row["id"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Edit</span>
                  </a><br>
                  <a href="siswa_remove.php?id=<?= $row["id"]; ?>" >
