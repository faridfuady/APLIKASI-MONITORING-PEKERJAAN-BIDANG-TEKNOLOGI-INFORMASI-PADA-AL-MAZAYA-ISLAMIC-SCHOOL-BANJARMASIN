...
if(isset($_POST["submit"])) {
  if(tambahproject($_POST)>0) {
    echo "<script>alert('Data project Berhasil Ditambah');document.location.href = 'project_show.php';</script>";


  } 
  else {
    // echo "<script>alert('Data project Gagal Ditambah');document.location.href = 'project_show.php';</script>";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data project <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nama_project" name="nama_project" autocomplete="off"required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="anggaran" name="anggaran" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="tanggal_mulai" class="form-label">Tanggal Mulai</label>
              <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" autocomplete="off"required>
            </div>
            <div class="mb-3">
