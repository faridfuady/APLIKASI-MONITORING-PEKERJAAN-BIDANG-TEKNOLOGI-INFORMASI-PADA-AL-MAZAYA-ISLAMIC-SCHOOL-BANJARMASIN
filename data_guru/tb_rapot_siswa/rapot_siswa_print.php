...
$rapot = queryTampilrapot("SELECT * FROM tb_nilai_rapot GROUP BY nis");
        ...
        <div class="row">
          <div class="col-md">
            <a href="rapot_show.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-house-door-fill"></i> Kembali ke Data Rapot</button>
            </a>
                                ...
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><?= $row["kelas"]; ?></td>
                                      <td>
                                      <a href="rapot_filter.php?nis=<?= $row["nis"]; ?>">
                                          <span class="badge bg-warning"><i class="bi bi-printer"></i>Cetak</span>
                                        </a><br>
                                        <a href="rapot_update.php?nis=<?= $row["nis"]; ?>">
