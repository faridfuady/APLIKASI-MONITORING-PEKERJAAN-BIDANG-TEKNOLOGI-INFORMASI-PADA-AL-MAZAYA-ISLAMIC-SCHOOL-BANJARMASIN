...
$nis = $_GET["nis"];
$tb_nilai_rapot = queryTampilrapot("SELECT * FROM tb_nilai_rapot WHERE nis = $nis")[0];


if(isset($_POST["submit"])) {
  if(hapusrapot($id)>0) {
    echo"<script>alert('Data rapot Berhasil Dihapus');document.location.href = 'rapot_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data rapot Gagal Dihapus');document.location.href = 'rapot_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Master
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_rapot_siswa/rapot_show.php">rapot</a></li>
              </ul>
            </div>
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_rapot_siswa/rapot_print.php">rapot</a></li>
                <li><a class="dropdown-item" href="../../data/tb_rapot_siswa_rapot/rapot_rapot_print.php">rapot rapot</a></li>
                <li><a class="dropdown-item" href="../../data/tb_rapot_siswa/rapot_print.php">Data Rapot rapot</a></li>
    ...
    <!-- NAVBAR END -->
     ...
     <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Hapus Data rapot <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data Rapor</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      NIS
                      <div class="fw-bold"><?= $tb_nilai_rapot["nis"] ?></div>
                    </div>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama
                      <div class="fw-bold"><?= $tb_nilai_rapot["nama"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kelas
                      <div class="fw-bold"><?= $tb_nilai_rapot["kelas"] ?></div>
                    </div>
                  </li>
                  <!-- <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Mata Pelajaran
                      <div class="fw-bold"><?= $tb_nilai_rapot["mapel"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     tugas
                      <div class="fw-bold"><?= $tb_nilai_rapot["tugas"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     uts
                      <div class="fw-bold"><?= $tb_nilai_rapot["uts"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     uas
                      <div class="fw-bold"><?= $tb_nilai_rapot["uas"] ?></div>
                    </div>
                  </li> -->
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          ...
          <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data rapot</button>
            </form>
          </div>
        </div>
      </div>
