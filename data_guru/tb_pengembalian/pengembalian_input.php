...
if(isset($_POST["submit"])) {
  if(tambahpengembalian($_POST)>0) {
    echo "<script>alert('Data pengembalian Berhasil Ditambah');document.location.href = 'pengembalian_show.php';</script>";


  } 
  else {
    echo "<script>alert('Data pengembalian Gagal Ditambah');document.location.href = 'pengembalian_show.php';</script>";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data pengembalian <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="row">
          ...
          <div class="mb-3">
                ...
                <select class="form-select" name="kd_pinjam" id="kd_pinjam">
                  ...
                  <?php 
                    $sql_kd_pinjam = mysqli_query($conn, "SELECT * FROM tb_barang_pinjam_guru ORDER BY kd_pinjam ASC") or die (mysqli_error($conn));
                    while($data_kd_pinjam = mysqli_fetch_array($sql_kd_pinjam)) {
                      echo '
                      <option value="'.$data_kd_pinjam['kd_pinjam'].'">
                        '.$data_kd_pinjam['kd_pinjam'].'
                      </option>
                      ';
                    }
                  ?>
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="tanggal_pengembalian" name="tanggal_pengembalian" autocomplete="off"required>
            </div>
            <div class="mb-3">
                <label for="status" class="form-label">Status Pinjam</label>
                <input type="text" class="form-control" id="status" name="status" autocomplete="off"requireddisabled value="Ready">
              </div>
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data pengembalian</button>
          </form>
