...
if (isset($_POST['date_filter'])) {
  ...
  $rowsDateFilter = count(queryTampilpengembalian("SELECT * FROM tb_kryw_pengembalian WHERE tanggal_pengembalian BETWEEN '$startPost%' AND '$endPost%'"));
  ...
  $pengembalianDateFilter = queryTampilpengembalian("SELECT * FROM tb_kryw_pengembalian WHERE tanggal_pengembalian BETWEEN '$startPost%' AND '$endPost%'");
} 
?>  
