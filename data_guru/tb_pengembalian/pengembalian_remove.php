...
if(isset($_POST["submit"])) {
  if(hapuspengembalian($id)>0) {
    echo"<script>alert('Data pengembalian Berhasil Dihapus');document.location.href = 'pengembalian_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data pengembalian Gagal Dihapus');document.location.href = 'pengembalian_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Hapus Data pengembalian</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Hapus Data pengembalian <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data pengembalian</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kode Pinjam
                      <div class="fw-bold"><?= $tb_pengembalian["kd_pinjam"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal pengembalian
                      <div class="fw-bold"><?= $tb_pengembalian["tanggal_pengembalian"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Status
                      <div class="fw-bold"><?= $tb_pengembalian["status"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          ...
          <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data pengembalian</button>
            </form>
          </div>
        </div>
      </div>
