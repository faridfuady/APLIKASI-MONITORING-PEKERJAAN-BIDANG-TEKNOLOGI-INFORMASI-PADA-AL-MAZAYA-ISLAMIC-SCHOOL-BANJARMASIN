...
$pengembalian = queryTampilpengembalian("SELECT * FROM tb_pengembalian_guru");

if ( isset($_POST["caripengembalian"]) ) {
	$pengembalian = caripengembalian($_POST["keyword"]);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Data Pengembalian <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            <a href="../../index.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-house-door-fill"></i> Kembali ke Beranda</button>
            </a>
            <a href="pengembalian_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data pengembalian</button>
            </a>
            <a href="pengembalian_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data pengembalian</button>
            </a>
            <a href="pengembalian-read-date-filter.php">
                                ...
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td><?= $row["status"]; ?></td>
                                      <td>
                                      <a href="pengembalian_filter.php?id=<?= $row["id"]; ?>">
                                          <span class="badge bg-warning"><i class="bi bi-printer"></i>Cetak</span>
                                        </a><br>
                                        <a href="pengembalian_remove.php?id=<?= $row["id"]; ?>" >
