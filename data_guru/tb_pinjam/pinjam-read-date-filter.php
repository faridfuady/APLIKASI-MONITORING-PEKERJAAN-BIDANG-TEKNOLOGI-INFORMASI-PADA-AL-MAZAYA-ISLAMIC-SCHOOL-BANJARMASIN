...
if (isset($_POST['date_filter'])) {
  ...
  $rowsDateFilter = count(queryTampilpinjam("SELECT * FROM tb_kryw_pinjam WHERE tanggal_pinjam BETWEEN '$startPost%' AND '$endPost%'"));
  ...
  $pinjamDateFilter = queryTampilpinjam("SELECT * FROM tb_kryw_pinjam WHERE tanggal_pinjam BETWEEN '$startPost%' AND '$endPost%'");
} 
?>  
