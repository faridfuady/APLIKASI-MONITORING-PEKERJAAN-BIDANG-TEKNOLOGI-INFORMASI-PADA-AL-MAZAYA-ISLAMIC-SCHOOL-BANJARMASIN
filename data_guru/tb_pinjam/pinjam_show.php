...
$pinjam = queryTampilpinjam("SELECT * FROM tb_barang_pinjam_guru");

if ( isset($_POST["caripinjam"]) ) {
	$pinjam = caripinjam($_POST["keyword"]);
}

// $rowPerPage = 5;
// $rows = count(queryTampilpinjam("SELECT * FROM tb_dokumentasi"));
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Data Pinjam <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            <a href="../../index.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-house-door-fill"></i> Kembali ke Beranda</button>
            </a>
            <a href="pinjam_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Pinjam</button>
            </a>
            <a href="pinjam_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Pinjam</button>
            </a>
            <a href="pinjam-read-date-filter.php">
