...
if ( isset($_POST["caripemeliharaan"]) ) {
	$pemeliharaan = caripemeliharaan($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Tabel Data Pemeliharaan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Data Pemeliharaan <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            <a href="../../index.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-house-door-fill"></i> Kembali ke Beranda</button>
            </a>
            <a href="pemeliharaan_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Pemeliharaan</button>
            </a>
            <a href="pemeliharaan_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Pemeliharaan</button>
            </a>
            <a href="pemeliharaan-read-date-filter.php">
