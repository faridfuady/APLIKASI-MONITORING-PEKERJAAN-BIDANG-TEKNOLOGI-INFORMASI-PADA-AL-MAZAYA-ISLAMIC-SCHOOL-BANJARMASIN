...
$id = $_GET["id"];
$tb_pemeliharaan = queryTampilpemeliharaan("SELECT * FROM tb_pemeliharaan_inventaris WHERE id = $id");
// $pemeliharaan = queryTampilpemeliharaan("SELECT * FROM tb_pemeliharaan");
// $totalAnggaran = queryTampilpemeliharaan("SELECT SUM(anggaran) total_anggaran FROM tb_pemeliharaan");
...
<!DOCTYPE html>
            ...
            <body>
              <table align="center" cellpadding="10" cellspacing="0">
                ...
                <td><center>
                    ...
                    <font size="4">LAPORAN DATA PEMELIHARAAN</font><br>
       ...
       <th>No</th>
              ...
              $i = 1;
              foreach($tb_pemeliharaan as $row) {
$html .= '
                <tr>
                  <td>'. $i++ .'</td>
                  <td>'. $row["id_brg"] .'</td>
                  <td>'. $row["nama_brg"] .'</td>
                  <td>'. $row["tanggal  _pemeliharaan"] .'</td>
                  <td>'. $row["nm_kryw"] .'</td>
                </tr>';
    }  
$html .= '
