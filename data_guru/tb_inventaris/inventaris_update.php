        ...
        <div class="row">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="keterangan" name="keterangan" autocomplete="off"requiredvalue="<?= $tb_inventaris["keterangan"]; ?>">
            </div>
            <div class="mb-3">
              <label for="lokasi" class="form-label">lokasi Barang</label>
              <input type="text" class="form-control" id="lokasi" name="lokasi" autocomplete="off"requiredvalue="<?= $tb_inventaris["lokasi"]; ?>">
            </div>
