...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="data_karyawan/tb_perencanaan/perencanaan_print.php">Kegiatan Perencanaan</a></li>
          ...
          <div class="col-md-5">
            <ul class="list-group master-data link-dark">
              ...
              <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_inventaris/inventaris_show.php" class="nav-link text-dark ">
                <i class="bi bi-box-seam"></i> <i class="ms-3"></i> Data Inventaris
                </a>
              </li>
              <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_pinjam/pinjam_show.php" class="nav-link text-dark ">
                <i class="bi bi-chevron-double-right"></i><i class="ms-3"></i>  Data Pinjaman Inventaris
                </a>
              </li>
              <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_pengembalian/pengembalian_show.php" class="nav-link text-dark ">
                <i class="bi bi-chevron-double-left"></i><i class="ms-3"></i> Data Pengembalian Inventaris
                </a>
              </li> 
              <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_pemeliharaan/pemeliharaan_show.php" class="nav-link text-dark ">
                <i class="bi bi-inboxes"></i><i class="ms-3"></i> Data Pemeliharaan Barang
                </a>
              </li>
              <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_dokumentasi/dokumentasi_show.php" class="nav-link text-dark ">
                <i class="bi bi-camera"></i><i class="ms-3"></i>  Data Dokumentasi
                </a>
              </li>               
               <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_perencanaan/perencanaan_show.php" class="nav-link text-dark ">
                <i class="bi bi-calendar4-week"></i><i class="ms-3"></i>  Data Perencanaan Kegiatan
                </a>
              </li>  
              </li>               
               <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_kegiatan/kegiatan_show.php" class="nav-link text-dark ">
                <i class="bi bi-calendar4-week"></i><i class="ms-3"></i>  Data Pelaksanaan Kegiatan
                </a>
              </li> 
              <li class="list-group-item list-group-item-dark">
               ...
               <!-- <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_project/project_show.php" class="nav-link text-dark ">
                <i class="bi bi-calendar4-week"></i><i class="ms-3"></i>  Data Project
                </a>
              </li>                 -->
              <li class="list-group-item list-group-item-dark">
                <a href="data_karyawan/tb_kinerja/kinerja_show.php" class="nav-link text-dark ">
                <i class="bi bi-bar-chart-line"></i><i class="ms-3"></i>  Data Kinerja Karyawan
                </a>
              </li>
            </ul>  
          </div>
