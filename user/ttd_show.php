          ...
          <div class="col-md-6">
            <div class="card mb-3">
              <div class="card-body">
                ...
                <?php foreach ($tb_ttd as $row) : ?>
                <form method="post">
                <div class="mb-3">
                     <label for="nama" class="form-label">Nama Pimpinan</label>
                       <input type="hidden" class="form-control" id="id" name="id" required autocomplete="off"required   value="<?= $row["id"]; ?>">
                       <input type="text" class="form-control" id="nama" name="nama" required autocomplete="off"required   value="<?= $row["nama"]; ?>">
                </div>
