...
if (isset($_POST['date_filter'])) {
  ...
  $rowsDateFilter = count(queryTampilinventaris("SELECT * FROM tb_inventaris WHERE tanggal_inventaris BETWEEN '$startPost%' AND '$endPost%'"));
  ...
  $inventarisDateFilter = queryTampilinventaris("SELECT * FROM tb_inventaris WHERE tanggal_inventaris BETWEEN '$startPost%' AND '$endPost%'");
} 
?>  
              ...
              <div class="col">
                  ...
                  <button type="submit" name="date_filter" class="btn btn-info d-inline">Filter</button>
                   ...
                   <?php if (isset($_POST['date_filter'])) { ?>
                    <a href="inventaris-read-date-filter-savepdf.php?start_date=<?= $_POST['start_date']; ?>&end_date=<?= $_POST['end_date']; ?>" target="_blank">
                      <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data</button>
                    </a>
                      <?php } else { ?>
                        <a href="inventaris-read-date-filter-savepdf.php" target="_blank">
                          <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data</button>
                        </a>
                   <?php } ?>
            </a>
        ...
        <div class="row">
              <div class="col">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <?php $i = 1; ?>
                  <?php if (isset($_POST['date_filter'])) : ?>
                    <?php foreach ($inventarisDateFilter as $row) : ?>
                      <tbody>
                        <tr>
                        <th scope="row"><?= $i; ?></th>
                <td><?= $row["id_brg"]; ?></td>
