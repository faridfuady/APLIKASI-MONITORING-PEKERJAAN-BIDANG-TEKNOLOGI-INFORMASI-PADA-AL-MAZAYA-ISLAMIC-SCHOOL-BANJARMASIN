...
if(isset($_POST["submit"])) {
  if(tambahproject($_POST)>0) 
  {
    ...
    echo "<script>alert('Data project Gagal Ditambah');document.location.href = 'project_input.php';</script>";
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nm_project" name="nm_project" autocomplete="off"required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                        ...
                        <input type="date" class="form-control w-50" id="tgl_project" name="tgl_project" max="01-01-2006" required>
                    </div>
              <div class="mb-3">
