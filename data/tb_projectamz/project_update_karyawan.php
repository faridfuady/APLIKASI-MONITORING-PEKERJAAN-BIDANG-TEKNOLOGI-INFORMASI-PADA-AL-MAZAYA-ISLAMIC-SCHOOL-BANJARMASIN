...
if(isset($_POST["submit"])) {
  if(ubahproject($_POST)>0) {
    echo "<script>alert('Data Project Berhasil Diubah');document.location.href = 'project_show_karyawan.php';</script>";
    // echo mysqli_error($conn);
  } 
  else {
    echo "<script>alert('Data Project Gagal Diubah');document.location.href = 'project_update_karyawan.php';</script>";
