          ...
          <div class="col">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tanggal_pemeliharaan" name="tanggal_pemeliharaan" required autocomplete="off"requiredvalue="<?= $tb_pemeliharaan["tanggal_pemeliharaan"]; ?>">
              </div>
              <div class="mb-3">
                <label for="keterangan" class="form-label">Keterangan</label>
                <input type="text" class="form-control" id="keterangan" name="keterangan" required autocomplete="off"requiredvalue="<?= $tb_pemeliharaan["keterangan"]; ?>">
              </div>
              <div class="mb-3">
