...
if(isset($_POST["submit"])) {
  if(tambahkaryawan($_POST)>0) {
    echo "<script>alert('Data karyawan Berhasil Ditambah');document.location.href = 'karyawan_show.php';</script>";


  } 
  else {
    // echo "<script>alert('Data karyawan Gagal Ditambah');document.location.href = 'karyawan_show.php';</script>";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data karyawan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="row">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nm_kryw" name="nm_kryw" autocomplete="off"required>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data karyawan</button>
          </form>
