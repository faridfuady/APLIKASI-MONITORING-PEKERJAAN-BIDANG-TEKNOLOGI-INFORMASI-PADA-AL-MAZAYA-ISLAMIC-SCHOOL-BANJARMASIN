...
if(isset($_POST["submit"])) {
  if(ubahkaryawan($_POST)>0) {
    echo "<script>alert('Data karyawan Berhasil Diubah');document.location.href = 'karyawan_show.php';</script>";
  } else {
    // echo mysqli_error($conn);
    
    echo"<script>alert('Data karyawan Gagal Diubah');document.location.href = 'karyawan_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
 ...
 <!-- NAVBAR END -->
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Ubah Data karyawan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="row">
          ...
          <input type="hidden" name="id" value="<?= $tb_karyawan["id"]; ?>">
          <input type="hidden" name="gambarLama" value="<?= $tb_karyawan["gambar"]; ?>">
          <div class="mb-3">
              <label for="nip" class="form-label">NIP</label>
              <input type="text" class="form-control" id="nip" name="nip" autocomplete="off"required value="<?= $tb_karyawan["nip"]; ?>">
            </div>
            <div class="mb-3">
              <label for="nm_kryw" class="form-label">Nama Karyawan</label>
              <input type="text" class="form-control" id="nm_kryw" name="nm_kryw" autocomplete="off"required value="<?= $tb_karyawan["nm_kryw"]; ?>">
            </div>
            <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input type="text" class="form-control" id="email" name="email" autocomplete="off"requiredvalue="<?= $tb_karyawan["email"]; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="alamat" name="alamat" autocomplete="off"requiredvalue="<?= $tb_karyawan["alamat"]; ?>">
            </div>
            <div class="mb-3">
                <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?= $tb_karyawan["tanggal_lahir"]; ?>" required autocomplete="off"required>
              </div>
            <div class="mb-3">
                        <label for="gambar" class="form-label">Gambar <i>(Saat ini)</i></label> <br>
                        <img src="../../gambar/<?= $tb_karyawan['gambar']; ?>" width="200px" style="margin-bottom: 10px;">
                        <input class="form-control form-control-sm w-50" id="gambar" name="gambar" type="file">
                    </div>
            <div class="mb-3">
              <label for="jabatan" class="form-label">Jabatan</label>
              <input type="text" class="form-control" id="jabatan" name="jabatan" autocomplete="off"required value="<?= $tb_karyawan["jabatan"]; ?>">
            </div>
            <div class="mb-3">
              <label for="no_telp" class="form-label">No Telepon</label>
              <input type="number" class="form-control" id="no_telp" name="no_telp" autocomplete="off"requiredvalue="<?= $tb_karyawan["no_telp"]; ?>">
            </div>
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Ubah Data karyawan</button>
          </form>
