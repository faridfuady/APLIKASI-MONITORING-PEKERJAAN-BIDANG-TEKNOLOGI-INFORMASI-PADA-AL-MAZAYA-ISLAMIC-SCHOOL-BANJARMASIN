...
$id_dok = $_GET["id_dok"];
$tb_dokumentasi = queryTampildokumentasi("SELECT * FROM tb_dokumentasi WHERE id_dok = $id_dok");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Dokumentasi <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6 justify-content-center text-center head-print">
            <h2 style="font-family: 'Times New Roman'; font-weight: bold; color: rgb(12, 54, 117);"><br> LAPORAN DATA DOKUMENTASI <br>   AL-MAZAYA <br> </h2>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <table class="table table-bordered border-dark" style="font-family: 'Times New Roman';">
              ...
              <?php $i = 1; ?>
              <?php foreach($tb_dokumentasi as $row) : ?>    
              <tr>
                <td><?= $i ?></td>
                <td><?= $row["nm_dok"]; ?></td>
                <td><?= $row["nm_alat"]; ?></td>
      ...
      <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="dokumentasi_filter_savepdf.php?id_dok=<?= $row["id_dok"]; ?>" >
                    <button type="button" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data Dokumentasi</button>
                </a>
            </form>
          </div>
        </div>
