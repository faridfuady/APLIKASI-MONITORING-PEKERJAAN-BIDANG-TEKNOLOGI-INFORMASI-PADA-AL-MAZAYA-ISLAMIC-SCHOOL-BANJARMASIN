            ...
            <tbody>
              <tr>
                ...
                <a href="dokumentasi_filter_savepdf.php?id_dok=<?= $row["id_dok"]; ?>">
                  ...
                  <a href="dokumentasi_update_karyawan.php?id_dok=<?= $row["id_dok"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Edit</span>
                  </a><br>
                  <a href="dokumentasi_remove_karyawan.php?id_dok=<?= $row["id_dok"]; ?>" >
