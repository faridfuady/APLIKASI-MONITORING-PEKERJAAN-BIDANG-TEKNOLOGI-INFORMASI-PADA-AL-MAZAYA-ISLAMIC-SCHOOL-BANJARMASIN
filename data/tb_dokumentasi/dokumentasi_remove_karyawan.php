...
if(isset($_POST["submit"])) {
  if(hapusdokumentasi($id_dok)>0) {
    echo "<script>alert('Data dokumentasi Berhasil Dihapus');document.location.href = 'dokumentasi_show_karyawan.php';</script>";
  } 
  else {
    echo "<script>alert('Data dokumentasi Gagal Dihapus');document.location.href = 'dokumentasi_show_karyawan.php';</script>";
  }
}
      ...
      <div class="container">
        ...
        <div class="row mb-3">
          <div class="col-md-9">
            ...
            <a href="dokumentasi_show_karyawan.php">
              ...
              <div class="card-body">
                <ol class="list-group mb-3">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Alat
                      <div class="fw-bold"><?= $tb_dokumentasi["nm_alat"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Keterangan
                      <div class="fw-bold"><?= $tb_dokumentasi["keterangan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                  <div class="ms-2 me-auto">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Keadaan Cuaca
                      <div class="fw-bold"><?= $tb_dokumentasi["keadaan_cuaca"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tempat Pelaksanaan
                      <div class="fw-bold"><?= $tb_dokumentasi["tempat_pelaksanaan"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
