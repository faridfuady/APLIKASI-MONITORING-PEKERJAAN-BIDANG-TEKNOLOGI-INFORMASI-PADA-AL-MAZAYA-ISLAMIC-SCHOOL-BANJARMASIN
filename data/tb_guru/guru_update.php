...
if(isset($_POST["submit"])) {
  if(ubahguru($_POST)>0) {
    echo "<script>alert('Data guru Berhasil Diubah');document.location.href = 'guru_show.php';</script>";
  } else {
    echo mysqli_error($conn);
    
    // echo"<script>alert('Data guru Gagal Diubah');document.location.href = 'guru_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
 ...
 <!-- NAVBAR END -->
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Ubah Data guru <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="row">
          ...
          <input type="hidden" name="gambarLama" value="<?= $tb_guru["gambar"]; ?>">
          <div class="mb-3">
              <label for="nip" class="form-label">NIP</label>
              <input type="text" class="form-control" id="nip" name="nip" autocomplete="off"required value="<?= $tb_guru["nip"]; ?>">
            </div>
            <div class="mb-3">
              <label for="nama" class="form-label">Nama guru</label>
              <input type="text" class="form-control" id="nama" name="nama" autocomplete="off"required value="<?= $tb_guru["nama"]; ?>">
            </div>
            <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input type="text" class="form-control" id="email" name="email" autocomplete="off"requiredvalue="<?= $tb_guru["email"]; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="alamat" name="alamat" autocomplete="off"requiredvalue="<?= $tb_guru["alamat"]; ?>">
            </div>
            <div class="mb-3">
                <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?= $tb_guru["tanggal_lahir"]; ?>" required autocomplete="off"required>
              </div>
              <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="no_telp" name="no_telp" autocomplete="off"requiredvalue="<?= $tb_guru["no_telp"]; ?>">
            </div>
            <div class="mb-3">
              <label for="tahun" class="form-label">Tahun Masuk</label>
              <input type="year" class="form-control" id="tahun" name="tahun" autocomplete="off"requiredvalue="<?= $tb_guru["tahun"]; ?>">
            </div>
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Ubah Data guru</button>
          </form>
