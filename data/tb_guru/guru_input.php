...
if(isset($_POST["submit"])) {
  if(tambahguru($_POST)>0) {
    echo "<script>alert('Data guru Berhasil Ditambah');document.location.href = 'guru_show.php';</script>";


  } 
  else {
    // echo "<script>alert('Data guru Gagal Ditambah');document.location.href = 'guru_show.php';</script>";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data guru <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
        ...
        <div class="row">
          ...
          <div class="mb-3">
            ...
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data guru</button>
          </form>
