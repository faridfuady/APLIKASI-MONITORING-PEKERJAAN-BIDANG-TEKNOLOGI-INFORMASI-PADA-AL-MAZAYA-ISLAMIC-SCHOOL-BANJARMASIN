...
$guru = queryTampilguru("SELECT * FROM tb_guru WHERE jenis_kelamin = 'Perempuan'");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <a href="guru_savepdf_perempuan.php">
    ...
    Jenis Kelamin
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_pinjam/pinjam_print.php">Perempuan</a></li>
              </ul>
            </div>
