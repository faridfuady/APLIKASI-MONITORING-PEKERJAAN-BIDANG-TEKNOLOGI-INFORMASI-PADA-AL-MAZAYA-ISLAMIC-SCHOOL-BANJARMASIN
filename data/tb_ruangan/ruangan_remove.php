...
if(isset($_POST["submit"])) {
  if(hapusruangan($id)>0) {
    echo"<script>alert('Data ruangan Berhasil Dihapus');document.location.href = 'ruangan_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data ruangan Gagal Dihapus');document.location.href = 'ruangan_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Hapus Data ruangan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Hapus Data ruangan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <a href="../../index.php">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data ruangan</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      ruangan
                      <div class="fw-bold"><?= $tb_ruangan["ruangan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Guru
                      <div class="fw-bold"><?= $tb_ruangan["guru"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Jumlah Siswa
                      <div class="fw-bold"><?= $tb_ruangan["jumlah_siswa"] ?></div>
                    </div>
                  </li>
        ...
        <div class="row">
          ...
          <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data ruangan</button>
            </form>
          </div>
        </div>
      </div>
