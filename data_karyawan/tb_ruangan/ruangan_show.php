...
<html lang="en">
  <head>
    ...
    <title>Tabel Data ruangan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Master
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li><a class="dropdown-item" href="data/tb_ruangan/ruangan_show.php">ruangan</a></li>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark-dark mb-5 text-center">Tabel Data ruangan <br> AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md-7">
            ...
            <a href="ruangan_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data ruangan</button>
            </a>
            <a href="ruangan_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data ruangan</button>
            </a>
          </div>
          <div class="col-md-5">
            <div class="input-group mb-3">
              <form action="" method="post" class="d-flex">         
                <input type="text" class="form-control" placeholder="Cari Nama ruangan" name="keyword" size="70">
                <button class="btn btn-outline-primary ms-1" type="submit" name="cariruangan"><i class="bi bi-search"></i></button>
              </form>
            </div>
          </div>
        </div>
