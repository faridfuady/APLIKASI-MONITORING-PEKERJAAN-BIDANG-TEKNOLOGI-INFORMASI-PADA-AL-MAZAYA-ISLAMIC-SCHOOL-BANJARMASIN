...
function tambahperencanaan($data) {
  ...
  $pa = htmlspecialchars($data["pa"]);
  $ka = htmlspecialchars($data["ka"]);
  $pro = htmlspecialchars($data["pro"]);
  $tro = htmlspecialchars($data["tro"]);
  $tempat = htmlspecialchars($data["tempat"]);
  $penanggung = htmlspecialchars($data["penanggung"]);

  
  $queryTambahperencanaan = "INSERT INTO tb_perencanaan VALUES ('','$nama', '$waktu','$pa','$ka','$pro','$tro', '$tempat' ,'$penanggung')";
