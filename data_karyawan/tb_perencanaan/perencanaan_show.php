...
if ( isset($_POST["cariperencanaan"]) ) {
	$perencanaan = cariperencanaan($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Tabel Data perencanaan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_perencanaan/perencanaan_print.php">perencanaan</a></li>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Perencanaan Kegiatan <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            ...
            <a href="perencanaan_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Kegiatan Perencanaan</button>
            </a>
            <a href="perencanaan_savepdf.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Perencanaan</button>
            </a>
            <a href="perencanaan-read-date-filter.php">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <li><a class="dropdown-item" href="perencanaan_showjanuari.php">Januari</a></li>
...
<div class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?= $row["nama"]; ?></td>
                <td><?= $row["waktu"]; ?></td>
                <td>Rp. <?= number_format($row["pa"]); ?></td>
                <td>Rp. <?= number_format($row["ka"]); ?></td>
                <td>Rp. <?= number_format($row["pro"]); ?></td>
                <td>Rp. <?= number_format($row["tro"]); ?></td>
                <td><?= $row["tempat"]; ?></td>
                <td><?= $row["penanggung"]; ?></td>
                <td>
                <a href="perencanaan_filter.php?id=<?= $row["id"]; ?>">
                    <span class="badge bg-warning"><i class="bi bi-printer"></i>Cetak</span>
                  </a><br>
                  <a href="perencanaan_update.php?id=<?= $row["id"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Edit</span>
                  </a><br>
                  <a href="perencanaan_remove.php?id=<?= $row["id"]; ?>" >
