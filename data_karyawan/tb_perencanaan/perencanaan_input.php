...
if(isset($_POST["submit"])) {
  if(tambahperencanaan($_POST)>0) {
    echo "<script>alert('Data perencanaan Berhasil Ditambah');document.location.href = 'perencanaan_show.php';</script>";


  } 
  else {
    // echo "<script>alert('Data perencanaan Gagal Ditambah');document.location.href = 'perencanaan_show.php';</script>";
...
<html lang="en">
  <head>
    ...
    <title>Tambah Data perencanaan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data perencanaan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            ...
            <a href="perencanaan_show.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-table"></i> Tabel Data perencanaan</button>
            </a>
          </div>
        </div>
        <div class="row">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="waktu" name="waktu" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="pa" class="form-label">Produksi Anggaran</label>
              <input type="text" class="form-control" id="pa" name="pa" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="ka" class="form-label">Konsumsi Anggaran</label>
              <input type="text" class="form-control" id="ka" name="ka" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="pro" class="form-label">Promosi Anggaran</label>
              <input type="text" class="form-control" id="pro" name="pro" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="tro" class="form-label">Transportasi Anggaran</label>
              <input type="text" class="form-control" id="tro" name="tro" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="tempat" class="form-label">Tempat</label>
              <input type="text " class="form-control" id="tempat" name="tempat" autocomplete="off"required>
            </div>
            <div class="mb-3">
                <label for="penanggung" class="form-label">Karyawan yang bertugas</label>
                <select class="form-select" name="penanggung" id="penanggung">
            ...
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data project</button>
          </form>
