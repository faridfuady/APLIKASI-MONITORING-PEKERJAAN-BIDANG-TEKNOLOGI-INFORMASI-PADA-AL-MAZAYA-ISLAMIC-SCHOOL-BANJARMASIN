...
$id = $_GET["id"];
$tb_perencanaan = queryTampilperencanaan("SELECT * FROM tb_perencanaan WHERE id = $id")[0];
 $sql_nip = mysqli_query($conn, "SELECT * FROM tb_karyawan ORDER BY nip ASC") or die (mysqli_error($conn));


if(isset($_POST["submit"])) {
  if(hapusperencanaan($id)>0) {
    echo"<script>alert('Data perencanaan Berhasil Dihapus');document.location.href = 'perencanaan_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data perencanaan Gagal Dihapus');document.location.href = 'perencanaan_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Hapus Data perencanaan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Hapus Data perencanaan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
              ...
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Project
                      <div class="fw-bold"><?= $tb_perencanaan["nama"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Keterangan
                      <div class="fw-bold"><?= $tb_perencanaan["keterangan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                     <div class="ms-2 me-auto">
                    ...
                    <div class="ms-2 me-auto">
                      tempat
                      <div class="fw-bold"><?= $tb_perencanaan["tempat"] ?></div>
                    </div>
                  </li>
                   <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      anggaran
                      <div class="fw-bold"><?= $tb_perencanaan["anggaran"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Mulai
                      <div class="fw-bold"><?= $tb_perencanaan["tanggal_mulai"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Karyawan
                      <div class="fw-bold"><?= $tb_perencanaan["nm_kryw"] ?></div>
                    </div>
                  </li>
                </ol>
