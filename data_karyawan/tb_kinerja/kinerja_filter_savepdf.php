...
$id = $_GET["id"];
$tb_guru_kinerja = queryTampilkinerja("SELECT * FROM tb_karyawan_kinerja WHERE id = $id");
  ...
  <body>
    <table align="center" cellpadding="10" cellspacing="0">
      ...
      <td><center>
          ...
          <font size="4">LAPORAN DATA KINERJA KARYAWAN</font><br>
     ...
     <table border="1" cellpadding="10" cellspacing="0">
                 ...
                 <th>No</th>
                 <th>NIP</th>
                 <th style="width: 21%">Nama Karyawan</th>
