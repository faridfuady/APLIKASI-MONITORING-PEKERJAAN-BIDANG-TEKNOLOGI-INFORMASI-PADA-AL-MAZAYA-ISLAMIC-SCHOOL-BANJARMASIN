...
$kinerja = queryTampilkinerja("SELECT * FROM tb_karyawan_kinerja");

if ( isset($_POST["carikinerja"]) ) {
	$kinerja = carikinerja($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Tabel Data Kinerja</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Data Kinerja <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            ...
            <a href="kinerja_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Kinerja</button>
            </a>
            <a href="kinerja_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Kinerja</button>
            </a>
            <!-- <a href="kinerja-read-date-filter.php">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <li><a class="dropdown-item" href="kinerja_showjanuari.php">Januari</a></li>
            ...
            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                      ...
                                      <th scope="col">Nilai Integritas</th>
                                      <th scope="col">Nilai Tanggung Jawab</th>
                                      <th scope="col">Nilai Komunikasi</th>
                                      <th scope="col">Nilai Antusiasme</th>
                                      <th scope="col">Tahun Kinerja</th>
                                      <th>Aksi</th>
                                    </tr>
                                    </thead>
                                    <tbody>
