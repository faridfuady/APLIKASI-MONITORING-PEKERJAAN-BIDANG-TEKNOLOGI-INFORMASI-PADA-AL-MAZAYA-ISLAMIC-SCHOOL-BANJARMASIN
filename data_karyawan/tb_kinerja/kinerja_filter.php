...
if(isset($_POST["submit"])) {
  if(hapuskinerja($id)>0) {
    echo"<script>alert('Data kinerja Berhasil Dihapus');document.location.href = 'kinerja_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data kinerja Gagal Dihapus');document.location.href = 'kinerja_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_/pinjam_print.php">Pinjaman</a></li>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Kinerja <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Cetak Data Kinerja</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      NIP
                      <div class="fw-bold"><?= $tb_kinerja["nip"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kedisiplinan
                      <div class="fw-bold"><?= $tb_kinerja["kedisiplinan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Integritas
                      <div class="fw-bold"><?= $tb_kinerja["integritas"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggung Jawab
                      <div class="fw-bold"><?= $tb_kinerja["tanggung_jwb"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Komunikasi
                      <div class="fw-bold"><?= $tb_kinerja["komunikasi"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Antusiasme
                      <div class="fw-bold"><?= $tb_kinerja["antusiasme"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tahun 
                      <div class="fw-bold"><?= $tb_kinerja["tahun"] ?></div>
                    </div>
                  </li>
                </ol>
              </div>
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="kinerja_filter_savepdf.php?id=<?= $_GET["id"]; ?>" >
                    <button type="button"  class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data Pinjam</button>
                </a>
            </form>
          </div>
        </div>
