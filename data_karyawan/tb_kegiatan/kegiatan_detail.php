...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Detail Anggaran Data Kegiatan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Detail Anggaran Kegiatan</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Produksi
                      <div class="fw-bold">  Rp. <?= number_format($tb_kegiatan["produksi"]); ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                    Konsumsi
                      <div class="fw-bold">  Rp. <?= number_format($tb_kegiatan["konsumsi"]); ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Promosi
                      <div class="fw-bold">  Rp. <?= number_format($tb_kegiatan["promosi"]); ?></div>
                    </div>
                  </li>
                   ...
                   <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Transportasi
                      <div class="fw-bold">  Rp. <?= number_format($tb_kegiatan["transportasi"]); ?></div>
                    </div>
                  </li>
