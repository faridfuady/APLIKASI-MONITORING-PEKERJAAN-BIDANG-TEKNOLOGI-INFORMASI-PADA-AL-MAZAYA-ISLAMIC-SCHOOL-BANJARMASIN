...
$kegiatan = queryTampilkegiatan("SELECT * FROM tb_kegiatan");

if ( isset($_POST["carikegiatan"]) ) {
	$kegiatan = carikegiatan($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Tabel Data kegiatan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_kegiatan/kegiatan_print.php">kegiatan</a></li>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Pelaksanaan  Kegiatan <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            ...
            <a href="kegiatan_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Pelaksanaan kegiatan</button>
            </a>
            <a href="kegiatan_savepdf.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Pelaksana kegiatan</button>
            </a>
            <a href="kegiatan-read-date-filter.php">
            <button type="button" class="btn btn-outline-primary"><i class="bi bi-calendar-date"></i> Filter Tanggal</button>
            </a>
            <a href="../tb_persandingan/persandingan_show.php">
            <button type="button" class="btn btn-outline-primary"><i class="bi bi-calendar-date"></i> Persandingan Kegiatan</button>
            </a>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <li><a class="dropdown-item" href="kegiatan_showjanuari.php">Januari</a></li>
...
<div class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                $total = $produksi+$konsumsi+$promosi+$transportasi;
                ?>
                <td>Rp. <?= number_format($total); ?></td>
                <td><?= $row["lokasi"]; ?></td>
                <td><?= $row["kryw"]; ?></td>
                <td><img src="../../gambar/<?php echo $row["gambar"]; ?>"width="200px"></td>
                <td>
                <a href="kegiatan_filter.php?id=<?= $row["id"]; ?>">
                    <span class="badge bg-warning"><i class="bi bi-printer"></i>Cetak</span>
                  </a><br>
                  <a href="kegiatan_update.php?id=<?= $row["id"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Edit</span>
                  </a><br>
                  <a href="kegiatan_detail.php?id=<?= $row["id"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Detail Anggaran</span>
                  </a><br>
                  <a href="kegiatan_remove.php?id=<?= $row["id"]; ?>" >
