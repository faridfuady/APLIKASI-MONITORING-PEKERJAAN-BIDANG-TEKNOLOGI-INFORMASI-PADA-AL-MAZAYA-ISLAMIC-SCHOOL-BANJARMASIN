...
<html lang="en">
  <head>
    ...
    <title>Cetak Data project</title>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            ...
            <a href="project_savepdf.php" target="_blank">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-save-fill"></i> Unduh Data project</button>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-3">
          ...
          <div class="col-md-9 justify-content-center text-center head-print">
            <h2 style="font-family: 'Times New Roman'; font-weight: bold; color: rgb(12, 54, 117);"><br> LAPORAN DATA project <br>   AL-MAZAYA</h2>
          </div>
        </div>
        <div class="row">
          <div class="col">
