...
$id = $_GET["id"];
$tb_kegiatan = queryTampilkegiatan("SELECT * FROM tb_kegiatan WHERE id = $id")[0];


if(isset($_POST["submit"])) {
  if(hapuskegiatan($id)>0) {
    echo"<script>alert('Data kegiatan Berhasil Dihapus');document.location.href = 'kegiatan_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data kegiatan Gagal Dihapus');document.location.href = 'kegiatan_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data kegiatan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Cetak Data kegiatan</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama kegiatan
                      <div class="fw-bold"><?= $tb_kegiatan["nama_kegiatan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Keterangan
                      <div class="fw-bold"><?= $tb_kegiatan["keterangan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                     <div class="ms-2 me-auto">
                        <label for="gambar" class="form-label">Gambar <i>(Saat ini)</i></label> <br>
                        <img src="../../gambar/<?= $tb_kegiatan['gambar']; ?>" width="200px"  style="margin-bottom: 10px;">
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tempat
                      <div class="fw-bold"><?= $tb_kegiatan["tempat"] ?></div>
                    </div>
                  </li>
                   <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Anggaran
                      <div class="fw-bold"><?= $tb_kegiatan["anggaran"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Mulai
                      <div class="fw-bold"><?= $tb_kegiatan["tanggal_mulai"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Karyawan
                      <div class="fw-bold"><?= $tb_kegiatan["nm_kryw"] ?></div>
                    </div>
                  </li>
                </ol>
              </div>
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="kegiatan_filter_savepdf.php?id=<?= $_GET["id"]; ?>" >
