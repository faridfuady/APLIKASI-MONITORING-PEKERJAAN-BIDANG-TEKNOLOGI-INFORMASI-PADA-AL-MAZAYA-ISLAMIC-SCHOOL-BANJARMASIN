...
if(isset($_POST["submit"])) {
  if(tambahmapel($_POST)>0) {
    echo "<script>alert('Data mapel Berhasil Ditambah');document.location.href = 'mapel_show.php';</script>";


  } 
  else {
    // echo "<script>alert('Data mapel Gagal Ditambah');document.location.href = 'mapel_show.php';</script>";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data mapel <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="mb-3">
              ...
              <input type="text" class="form-control" id="mapel" name="mapel" autocomplete="off"required>
            </div>
            <div class="mb-3">
              <label for="kkm" class="form-label">Nilai KKM</label>
              <input type="text" class="form-control" id="kkm" name="kkm" autocomplete="off"required>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data Mata Pelajaran</button>
          </form>
