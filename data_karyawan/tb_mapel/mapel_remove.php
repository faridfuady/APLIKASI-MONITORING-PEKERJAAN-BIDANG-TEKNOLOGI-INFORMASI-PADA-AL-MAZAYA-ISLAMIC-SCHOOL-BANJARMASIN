...
if(isset($_POST["submit"])) {
  if(hapusmapel($id)>0) {
    echo"<script>alert('Data mapel Berhasil Dihapus');document.location.href = 'mapel_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data mapel Gagal Dihapus');document.location.href = 'mapel_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Hapus Data mapel <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data mapel</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Mata Pelajaran
                      <div class="fw-bold"><?= $tb_mapel["mapel"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      KKM
                      <div class="fw-bold"><?= $tb_mapel["kkm"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Guru
                      <div class="fw-bold"><?= $tb_mapel["guru"] ?></div>
                    </div>
                  </li>
        ...
        <div class="row">
          ...
          <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data mapel</button>
            </form>
          </div>
        </div>
      </div>
