...
$mapel = queryTampilmapel("SELECT * FROM tb_mapel");

if ( isset($_POST["carimapel"]) ) {
	$mapel = carimapel($_POST["keyword"]);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Data Mata Pelajaran <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            ...
            <a href="mapel_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Mata Pelajaran</button>
            </a>
            <a href="mapel_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Mata Pelajaran</button>
            </a>
            <a href="mapel-read-date-filter.php">
