...
$tb_peralatan = queryTampilperalatan("SELECT * FROM tb_peralatan WHERE id_alat = $id_alat");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Peralatan <br>  </h1>
        <div class="row">
          <div class="col">
            ...
            <a href="peralatan_savepdf.php" target="_blank">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-save-fill"></i> Unduh Data peralatan</button>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-3">
          ...
          <div class="col-md-6 justify-content-center text-center head-print">
            <h2 style="font-family: 'Times New Roman'; font-weight: bold; color: rgb(12, 54, 117);"> <br> LAPORAN DATA PERALATAN <br>   AL-MAZAYA</h2>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <table class="table table-bordered border-dark" style="font-family: 'Times New Roman';">
              ...
              <?php $i = 1; ?>
              <?php foreach($tb_peralatan as $row) : ?>    
              <tr>
                <td><?= $i ?></td>
                <td><?= $row["nm_alat"]; ?></td>
      ...
      <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="peralatan_filter_savepdf.php?id_alat=<?= $row["id_alat"]; ?>" >
