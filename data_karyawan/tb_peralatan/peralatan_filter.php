...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Peralatan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Cetak Filter Data Peralatan</h5>
              </div>
              <div class="card-body">
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="peralatan_filter_print.php?id_alat=<?= $_GET["id_alat"]; ?>" >
                    <button type="button"  class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data Peralatan</button>
                </a>
            </form>
          </div>
        </div>
