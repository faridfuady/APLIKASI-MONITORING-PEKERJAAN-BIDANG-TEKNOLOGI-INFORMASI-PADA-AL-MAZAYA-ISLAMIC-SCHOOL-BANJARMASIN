...
$karyawan = queryTampilkaryawan("SELECT * FROM tb_karyawan WHERE jenis_kelamin = 'Perempuan'");

if ( isset($_POST["carikaryawan"]) ) {
	$karyawan = carikaryawan($_POST["keyword"]);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark-dark mb-5 text-center">Tabel Data Karyawan <br> AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md-7">
            ...
            <a href="karyawan_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data karyawan</button>
            </a>
            <a href="karyawan_savepdf_perempuan.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Karyawan</button>
            </a>
          </div>
    ...
    Jenis Kelamin
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li><a class="dropdown-item" href="../../data/tb_karyawan/karyawan_show_laki-laki.php">Laki - Laki</a></li>
                <li><a class="dropdown-item" href="../../data/tb_karyawan/karyawan_show_perempuan.php">Perempuan</a></li>
              </ul>
            </div>
          <div class="col-md-5">
            <div class="input-group mb-3">
              <form action="" method="post" class="d-flex">         
                <input type="text" class="form-control" placeholder="Cari Nama karyawan" name="keyword" size="70">
                <button class="btn btn-outline-primary ms-1" type="submit" name="carikaryawan"><i class="bi bi-search"></i></button>
              </form>
            </div>
          </div>
        </div>
