...
$id_kryw = $_GET["id_kryw"];
$tb_karyawan = queryTampilkaryawan("SELECT * FROM tb_karyawan WHERE id_kryw = $id_kryw");
      ...
      <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="karyawan_filter_savepdf.php?id_kryw=<?= $row["id_kryw"]; ?>" >
