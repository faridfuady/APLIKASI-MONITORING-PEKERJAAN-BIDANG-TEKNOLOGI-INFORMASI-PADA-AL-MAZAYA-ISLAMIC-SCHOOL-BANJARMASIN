...
$perencanaan = queryTampilperencanaan("SELECT * FROM tb_persandingan");
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md">
            ...
            <a href="persandingan_savepdf.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Persandingan</button>
            </a>
