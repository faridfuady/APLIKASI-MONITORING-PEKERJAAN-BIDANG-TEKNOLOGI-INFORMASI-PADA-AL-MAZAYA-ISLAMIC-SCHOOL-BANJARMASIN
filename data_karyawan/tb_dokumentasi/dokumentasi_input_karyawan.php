...
if(isset($_POST["submit"])) {
  ...
  if(tambahdokumentasi($_POST)>0) {
    echo "<script>alert('Data dokumentasi Berhasil Ditambah');document.location.href = 'dokumentasi_show_karyawan.php';</script>";
    // echo mysqli_error($conn);
  } 
  else {
    echo "<script>alert('Data dokumentasi Gagal Ditambah');document.location.href = 'dokumentasi_show_karyawan.php';</script>";
          ...
          <div class="col">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="keadaan_cuaca" name="keadaan_cuaca" required autocomplete="off"required>
              </div>
              <div class="mb-3">
                <label for="tempat_pelaksanaan" class="form-label">Tempat Pelaksanaan</label>
                <input type="text" class="form-control" id="tempat_pelaksanaan" name="tempat_pelaksanaan" required autocomplete="off"required>
              </div>
