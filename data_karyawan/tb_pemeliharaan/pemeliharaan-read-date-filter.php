...
if (isset($_POST['date_filter'])) {
  ...
  $rowsDateFilter = count(queryTampilpemeliharaan("SELECT * FROM tb_pemeliharaan_inventaris WHERE tanggal_pemeliharaan BETWEEN '$startPost%' AND '$endPost%'"));
  ...
  $pemeliharaanDateFilter = queryTampilpemeliharaan("SELECT * FROM tb_pemeliharaan_inventaris WHERE tanggal_pemeliharaan BETWEEN '$startPost%' AND '$endPost%'");
} 
?>  
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data/tb_pemeliharaan_inventaris/pemeliharaan_print.php">Pemeliharaan Barang</a></li>
              ...
              <div class="col">
                  ...
                  <button type="submit" name="date_filter" class="btn btn-info d-inline">Filter</button>
                   ...
                   <?php if (isset($_POST['date_filter'])) { ?>
                    <a href="pemeliharaan_savepdf_filter.php?start_date=<?= $_POST['start_date']; ?>&end_date=<?= $_POST['end_date']; ?>" target="_blank">
                      <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data</button>
                    </a>
                      <?php } else { ?>
                        <a href="pemeliharaan_savepdf_filter.php" target="_blank">
                          <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data</button>
                        </a>
                   <?php } ?>
            </a>
            ...
            <div class="row">
              <div class="col">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <?php $i = 1; ?>
                  <?php if (isset($_POST['date_filter'])) : ?>
                    <?php foreach ($pemeliharaanDateFilter as $row) : ?>
                      <tbody>
                        <tr>
                          <th scope="row"><?= $i; ?></th>
                          <th><?= $row['id_brg']; ?></th>
                          <th><?= $row['nama_brg']; ?></th>
                          <th><?= $row['tanggal_pemeliharaan']; ?></th>
                          <th><?= $row['nm_kryw']; ?></th>
