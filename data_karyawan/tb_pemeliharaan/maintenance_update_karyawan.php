...
$tb_maintenance = queryTampilmaintenance("SELECT * FROM tb_maintenance WHERE id_maintenance= $id_maintenance")[0];

if(isset($_POST["submit"])) {
  if(ubahmaintenance($_POST)>0) 
  // {   echo mysqli_error($conn); 
  // }
  {
    echo "<script>alert('Data maintenance Berhasil Diubah');document.location.href = 'maintenance_show_karyawan.php';</script>";
  } else {echo mysqli_error($conn);
    echo "<script>alert('Data maintenance Gagal Diubah');document.location.href = 'maintenance_show_karyawan.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Ubah Data maintenance</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Ubah Data Maintenance <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            ...
            <a href="maintenance_show_karyawan.php">
        ...
        <div class="row">
          <div class="col">
            <form method="post">
            <input type="hidden" name="id" value="<?= $tb_maintenance["id_maintenance"]; ?>">
            <div class="mb-3">
                <label for="nm_maintenance" class="form-label">Nama Maintenance</label>
                <input type="text" class="form-control" id="nm_maintenance" name="nm_maintenance" required autocomplete="off"requiredvalue="<?= $tb_maintenance["nm_maintenance"]; ?>">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="keterangan" name="keterangan" required autocomplete="off"requiredvalue="<?= $tb_maintenance["keterangan"]; ?>">
              </div>
              <div class="mb-3">
                <label for="jadwal" class="form-label">Jadwal</label>
                <input type="date" class="form-control" id="jadwal" name="jadwal" required autocomplete="off"requiredvalue="<?= $tb_maintenance["jadwal"]; ?>">
              </div>
              <div class="mb-3">
