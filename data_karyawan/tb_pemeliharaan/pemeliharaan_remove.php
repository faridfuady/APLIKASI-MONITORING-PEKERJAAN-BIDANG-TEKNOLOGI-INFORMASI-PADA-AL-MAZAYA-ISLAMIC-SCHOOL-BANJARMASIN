...
if(isset($_POST["submit"])) {
  if(hapuspemeliharaan($id)>0) {
    echo "<script>alert('Data pemeliharaan Berhasil Dihapus');document.location.href = 'pemeliharaan_show.php';</script>";
  } else {
    echo "<script>alert('Data pemeliharaan Gagal Dihapus');document.location.href = 'pemeliharaan_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Hapus Data pemeliharaan</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Hapus Data pemeliharaan <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data pemeliharaan</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Barang
                      <div class="fw-bold"><?= $tb_pemeliharaan["id_brg"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Pemeliharaan
                      <div class="fw-bold"><?= $tb_pemeliharaan["tanggal_pemeliharaan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Karyawan
                      <div class="fw-bold"><?= $tb_pemeliharaan["nm_kryw"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Catatan Tambahan
                      <div class="fw-bold"><?= $tb_pemeliharaan["catatan"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data Pemeliharaan</button>
            </form>
          </div>
        </div>
      </div>
