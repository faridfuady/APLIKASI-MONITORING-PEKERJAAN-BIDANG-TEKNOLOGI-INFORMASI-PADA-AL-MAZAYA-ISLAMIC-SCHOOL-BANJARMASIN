...
if (isset($_POST['date_filter'])) {
  ...
  $rowsDateFilter = count(queryTampilproject("SELECT * FROM tb_project WHERE tanggal_mulai BETWEEN '$startPost%' AND '$endPost%'"));
  ...
  $projectDateFilter = queryTampilproject("SELECT * FROM tb_project WHERE tanggal_mulai BETWEEN '$startPost%' AND '$endPost%'");
} 
?>  
              ...
              <div class="col">
                  ...
                  <button type="submit" name="date_filter" class="btn btn-info d-inline">Filter</button>
                   ...
                   <?php if (isset($_POST['date_filter'])) { ?>
                    <a href="project-read-date-filter-savepdf.php?start_date=<?= $_POST['start_date']; ?>&end_date=<?= $_POST['end_date']; ?>" target="_blank">
                      <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Project</button>
                    </a>
                      <?php } else { ?>
                        <a href="project-read-date-filter-savepdf.php" target="_blank">
        ...
        <div class="row">
              <div class="col">
                ...
                <th scope="col">Nama Karyawan</th>
                  ...
                  <?php $i = 1; ?>
                  <?php if (isset($_POST['date_filter'])) : ?>
                    <?php foreach ($projectDateFilter as $row) : ?>
                      <tbody>
                        <tr>
                        <th scope="row"><?= $i; ?></th>
