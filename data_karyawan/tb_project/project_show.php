...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md">
            ...
            <a href="project-read-date-filter.php">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <li><a class="dropdown-item" href="project_showjanuari.php">Januari</a></li>
...
<div class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="../../gambar/<?php echo $row["gambar"]; ?>"width="180px"></td>
                <td><?= $row["tempat"]; ?></td>
