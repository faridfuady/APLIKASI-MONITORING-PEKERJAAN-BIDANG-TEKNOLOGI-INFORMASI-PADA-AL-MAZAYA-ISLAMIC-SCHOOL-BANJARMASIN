...
if(isset($_POST["submit"])) {
  if(hapusproject($id)>0) {
    echo"<script>alert('Data project Berhasil Dihapus');document.location.href = 'project_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data project Gagal Dihapus');document.location.href = 'project_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Project <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Cetak Data Project</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Project
                      <div class="fw-bold"><?= $tb_project["nama_project"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Keterangan
                      <div class="fw-bold"><?= $tb_project["keterangan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                     <div class="ms-2 me-auto">
                   ...
                   <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Anggaran
                      <div class="fw-bold"><?= $tb_project["anggaran"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Mulai
                      <div class="fw-bold"><?= $tb_project["tanggal_mulai"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="project_filter_savepdf.php?id=<?= $_GET["id"]; ?>" >
