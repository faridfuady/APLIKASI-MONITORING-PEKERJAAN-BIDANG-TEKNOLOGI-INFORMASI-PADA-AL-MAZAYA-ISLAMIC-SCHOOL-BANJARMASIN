...
function tambahproject($data) {
  ...
  $waktu_selesai = htmlspecialchars($data["tanggal_selesai"]);
  ...
  $queryTambahproject = "INSERT INTO tb_project VALUES ('','$nama_project', '$keterangan','$gambar', '$tempat' ,'$anggaran','$tanggal_mulai','$waktu_mulai','$waktu_selesai','$nm_kryw' )";
...
function cariproject($keyword) {
  ...
  $queryCariproject = "SELECT * FROM tb_project WHERE nama_project LIKE '%$keyword%'";
