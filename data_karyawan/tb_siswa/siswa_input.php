...
if(isset($_POST["submit"])) {
  if(tambahsiswa($_POST)>0) {
    echo "<script>alert('Data siswa Berhasil Ditambah');document.location.href = 'siswa_show.php';</script>";


  } 
  else {
    // echo "<script>alert('Data siswa Gagal Ditambah');document.location.href = 'siswa_show.php';</script>";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tambah Data siswa <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="mb-3">
              ...
              <input type="number" class="form-control" id="nis" name="nis" autocomplete="off"required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                        ...
                        <input type="date" class="form-control w-50" id="tanggal_lahir" name="tanggal_lahir" max="01-01-2006" required>
                    </div>
                    <div class="mb-3">
                        <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                        <input type="text" class="form-control w-50" id="tempat_lahir" name="tempat_lahir" max="01-01-2006" required>
                    </div>
            <div class="mb-3">
            ...
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data siswa</button>
          </form>
