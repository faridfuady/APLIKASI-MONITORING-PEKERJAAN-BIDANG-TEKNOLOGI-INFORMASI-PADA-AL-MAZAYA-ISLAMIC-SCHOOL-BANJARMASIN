            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <a href="project_update_karyawan.php?id_project=<?= $row["id_project"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Edit</span>
                  </a><br>
                  <a href="project_remove_karyawan.php?id_project=<?= $row["id_project"]; ?>" >
