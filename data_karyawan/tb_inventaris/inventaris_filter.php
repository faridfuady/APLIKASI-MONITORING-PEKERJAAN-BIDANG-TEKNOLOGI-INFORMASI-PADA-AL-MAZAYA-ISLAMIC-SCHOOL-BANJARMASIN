...
if(isset($_POST["submit"])) {
  if(hapusinventaris($id)>0) {
    echo"<script>alert('Data inventaris Berhasil Dihapus');document.location.href = 'inventaris_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data inventaris Gagal Dihapus');document.location.href = 'inventaris_show.php';</script>";
  }
}
?>
      ...
      <div class="container">
        ...
        <div class="row mb-3">
              ...
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      ID Barang
                      <div class="fw-bold"><?= $tb_inventaris["id_brg"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Barang
                      <div class="fw-bold"><?= $tb_inventaris["nama_brg"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                     <div class="ms-2 me-auto">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kondisi
                      <div class="fw-bold"><?= $tb_inventaris["kondisi"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Keterangan
                      <div class="fw-bold"><?= $tb_inventaris["keterangan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Lokasi
                      <div class="fw-bold"><?= $tb_inventaris["lokasi"] ?></div>
                    </div>
                  </li>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    Tanggal Barang Masuk
                      <div class="fw-bold"><?= $tb_inventaris["tanggal_inventaris"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                    Anggaran
                      <div class="fw-bold"><?= $tb_inventaris["anggaran"] ?></div>
                    </div>
                  </li>
                </ol>
                <div class="row">
          <div class="col">
            ...
            <a href="inventaris_filter_savepdf.php?id=<?= $_GET["id"]; ?>" >
                    <button type="button"  class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data inventaris</button>
                </a>
            </form>
          </div>
        </div>
