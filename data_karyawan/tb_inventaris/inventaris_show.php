...
if ( isset($_POST["cariinventaris"]) ) {
	$inventaris = cariinventaris($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Tabel Data Inventaris</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    Data Master
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data_karyawan/tb_guru/guru_show.php">Guru</a></li>
                <li><a class="dropdown-item" href="../../data_karyawan/tb_siswa/siswa_show.php">Siswa</a></li>
              </ul>
            </div>
    ...
    Data Laporan
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="../../data_karyawan/tb_guru/guru_print.php">Guru</a></li>
                <li><a class="dropdown-item" href="../../data_karyawan/tb_siswa/siswa_print.php">Siswa</a></li>
                <li><a class="dropdown-item" href="../../data_karyawan/tb_rapot_siswa/rapot_siswa_print.php">rapot Siswa</a></li>
                 
                <li><a class="dropdown-item" href="../../data_karyawan/tb_mapel/mapel_print.php">Data Mata Pelajaran</a></li>
              </ul>
            </div>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Tabel Data Inventaris <br>   AL-MAZAYA</h1>
        <div class="row">
          <div class="col-md">
            ...
            <a href="inventaris_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Inventaris</button>
            </a>
            <a href="inventaris_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Inventaris</button>
            </a>
            <a href="inventaris-read-date-filter.php">
            <button type="button" class="btn btn-outline-primary"><i class="bi bi-calendar-date"></i> Filter Tanggal</button>
            </a>
...
<div class="row">
            ...
            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($inventaris as $row) : ?>
                                        <tr>
                                          ...
                                          <td><?= $row["lokasi"]; ?></td>
                                          <td><?= date("d-M-Y", strtotime($row["tanggal_inventaris"])); ?></td>
                                          <td>Rp. <?= number_format($row["anggaran"]); ?></td>
                                          <td>
                                            <a href="inventaris_filter.php?id=<?= $row["id"]; ?>">
                                                <span class="badge bg-warning"><i class="bi bi-printer"></i>Cetak</span>
                                              </a><br>
                                              <a href="inventaris_update.php?id=<?= $row["id"]; ?>">
                                                <span class="badge bg-success"><i class="bi bi-pen-fill"></i>Edit</span>
                                              </a><br>
                                              <a href="inventaris_remove.php?id=<?= $row["id"]; ?>" >
                ...
                echo number_format($total['total_anggaran']) ; 
                } ?></td>
              </tr>
                                </table>
                            </div>
