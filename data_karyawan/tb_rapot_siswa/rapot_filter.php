...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Rapor Siswa <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            ...
            <a href="rapot_show.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-table"></i> Tabel Data Rapor</button>
            </a>
          </div>
        </div>
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Cetak Data Rapor</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      NIS
                      <div class="fw-bold"><?= $nama["nis"] ?> - <?= $nama["nama"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kelas
                      <div class="fw-bold"><?= $nama["kelas"] ?></div>
                    </div>
                  </li>
                </ol>
              </div>
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="rapot_filter_savepdf.php?nis=<?= $_GET["nis"]; ?>" >
                    <button type="button"  class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data Rapor</button>
                </a>
            </form>
          </div>
        </div>
