...
$id = $_GET["id"];
$tb_kelas = queryTampilkelas("SELECT * FROM tb_kelas WHERE id = $id")[0];


if(isset($_POST["submit"])) {
  if(hapuskelas($id)>0) {
    echo"<script>alert('Data kelas Berhasil Dihapus');document.location.href = 'kelas_show.php';</script>";
  } 
  else {
  
    echo"<script>alert('Data kelas Gagal Dihapus');document.location.href = 'kelas_show.php';</script>";
  }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Cetak Data Kelas <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Cetak Data Kelas</h5>
              </div>
              <div class="card-body">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kelas
                      <div class="fw-bold"><?= $tb_kelas["kelas"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                     Guru
                      <div class="fw-bold"><?= $tb_kelas["guru"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Jumlah Siswa
                      <div class="fw-bold"><?= $tb_kelas["jumlah_siswa"] ?></div>
                    </div>
                  </li>
                </ol>
              </div>
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
                <a href="kelas_filter_savepdf.php?id=<?= $_GET["id"]; ?>" >
                    <button type="button"  class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Cetak Data Kelas</button>
                </a>
            </form>
          </div>
        </div>
