...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
 ...
 <!-- NAVBAR END -->
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary-dark mb-5 text-center">Ubah Data kelas <br>   AL-MAZAYA</h1>
        <div class="row mb-3">
          <div class="col-md-9">
        ...
        <div class="row">
          ...
          <input type="hidden" name="id" value="<?= $tb_kelas["id"]; ?>">
          <!-- <input type="hidden" name="gambarLama" value="<?= $tb_kelas["gambar"]; ?>"> -->
          <div class="mb-3">
              <label for="kelas" class="form-label">Kelas</label>
              <input type="text" class="form-control" id="kelas" name="kelas" autocomplete="off"required value="<?= $tb_kelas["kelas"]; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="jumlah_siswa" name="jumlah_siswa" autocomplete="off"requiredvalue="<?= $tb_kelas["jumlah_siswa"]; ?>">
            </div>
           
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Ubah Data kelas</button>
          </form>
